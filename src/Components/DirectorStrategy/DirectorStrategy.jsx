  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.info}>
        ...
        <p>
          Alexander has more than 20 years' experience in the field of digital banking and fintech. He is ready to share his expertise and give you
          valuable advice during this webinar.
        </p>
